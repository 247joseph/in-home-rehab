import { a as defineComponent, C as h, D as useNuxtApp, E as useState, G as ref, e as computed, H as watch, I as withAsyncContext, u as unref, o as openBlock, f as createElementBlock, q as normalizeClass, c as createBlock, J as resolveDynamicComponent, t as toDisplayString, h as normalizeStyle, i as _export_sfc } from "./entry.9eba175a.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(isFetching) ? (openBlock(), createElementBlock("span", {
        key: 0,
        class: normalizeClass(unref(className)),
        width: unref(sSize),
        height: unref(sSize)
      }, null, 10, _hoisted_1)) : unref(icon) ? (openBlock(), createBlock(unref(Icon), {
        key: 1,
        icon: unref(icon),
        class: normalizeClass(unref(className)),
        width: unref(sSize),
        height: unref(sSize)
      }, null, 8, ["icon", "class", "width", "height"])) : unref(component) ? (openBlock(), createBlock(resolveDynamicComponent(unref(component)), {
        key: 2,
        class: normalizeClass(unref(className)),
        width: unref(sSize),
        height: unref(sSize)
      }, null, 8, ["class", "width", "height"])) : (openBlock(), createElementBlock("span", {
        key: 3,
        class: normalizeClass(unref(className)),
        style: normalizeStyle({ fontSize: unref(sSize), lineHeight: unref(sSize), width: unref(sSize), height: unref(sSize) })
      }, toDisplayString(__props.name), 7));
    };
  }
});
